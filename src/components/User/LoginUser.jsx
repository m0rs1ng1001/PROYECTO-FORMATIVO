  ...
  return (
    <div className="flex items-center justify-center h-screen bg-custom-pagina-fondo">
      ...
      <label className="w-full mb-2 font-semibold text-black px-4 py-3 rounded-md">Correo</label>
        ...
        <button className="bg-custom-botones text-white font-semibold mt-4 py-2 px-4 rounded hover:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-700 w-full"><a href="/Citas">iniciar sesion como lavadero</a></button>
